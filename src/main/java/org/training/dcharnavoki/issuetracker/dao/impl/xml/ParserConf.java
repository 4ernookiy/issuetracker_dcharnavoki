...
public class ParserConf extends DefaultParser implements IConfDAO {
	...
	public void endElement(String uri, String localName, String qName) throws SAXException {
		...
		case STATUS:
			...
			status.setDescription(valueTag);
			statuses.put(id, status);
			break;
		case PRIORITY:
			Priority priority = new Priority(id);
			priority.setDescription(valueTag);
			priorities.put(id, priority);
			break;
		case RESOLUTION:
			Resolution resolution = new Resolution(id);
			resolution.setDescription(valueTag);
			resolutions.put(id, resolution);
			break;
		case TYPE:
			Type type = new Type(id);
			type.setDescription(valueTag);
			types.put(id, type);
			break;
		default:
		}
