	...
	protected void performTask(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if ("update".equals(actionStr)) {
				...
				project = factory.getProjectDAO().findByID(projectId);
			}
			...
			if (!isUpdate) {
				...
				Integer newId = factory.getProjectDAO().save(project);
				build.setDescription(buildStr);
				build.setProjectId(newId);
				factory.getBuildDAO().save(build);
